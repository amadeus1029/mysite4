...
<div id="paging">
    <ul>
        ...
        <li>
            <a class="${pageVo.currPage le pageVo.pageNum ? 'off':''}" href="${pageContext.request.contextPath }/board/list?page=${pageVo.beginPage-10}&category=${param.category}&keyword=${param.keyword}">◀</a>
        </li>
        ...
        <li>
            <a class="${pageVo.totalPage - pageVo.beginPage lt pageVo.pageNum ? 'off':'' }" href="${pageContext.request.contextPath }/board/list?page=${pageVo.endPage+1}&category=${param.category}&keyword=${param.keyword}">▶</a>
        </li>
        <li>
